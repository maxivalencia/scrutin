...
class PopulationController extends AbstractController
{
     ...
     */
    public function index(Request $request, PopulationRepository $populationRepository, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $populationRepository->findBy([], ["id" => "DESC"]), /* query NOT result */
            $request->query->getInt('page', 1)/*page number*/,
            50/*limit per page*/
        );
        return $this->render('population/index.html.twig', [
            'populations' => $pagination,
        ]);
    }
