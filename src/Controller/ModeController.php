...
class ModeController extends AbstractController
{
     ...
     */
    public function index(Request $request, ModeRepository $modeRepository, PaginatorInterface $paginator): Response
    {
        $pagination = $paginator->paginate(
            $modeRepository->findBy([], ["id" => "DESC"]), /* query NOT result */
